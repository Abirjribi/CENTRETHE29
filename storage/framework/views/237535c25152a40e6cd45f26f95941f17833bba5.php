...
-->
  		...
  		<div class="container">
  			<div class="row">
  				<div class="col-lg-6 col-md-4 col-sm-3 tm-site-name-container">
  					<a href="#" class="tm-site-name">THE 29</a>	
  				</div>
	  			<div class="col-lg-6 col-md-8 col-sm-9">
	  				...
	  				<nav class="tm-nav">
                        ...
                        <li><a href="index.html" >Accueil</a></li>
							...
							<li><a href="event.html"class="active">Evénements</a></li>
		...
		<div class="row">
			...
			<div class="flexslider flexslider-about effect2">
			  <ul class="slides">
			    ...
			    <li>
			      <img src="<?php echo e(url('img/about-1.jpg')); ?>" alt="image" />
			      <div class="flex-caption">
 ...
 </html><?php /**PATH C:\xampp\htdocs\THE29\resources\views/event.blade.php ENDPATH**/ ?>