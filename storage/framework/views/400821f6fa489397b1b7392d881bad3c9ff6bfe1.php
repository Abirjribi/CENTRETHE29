...
-->
	  			...
	  			<div class="col-lg-6 col-md-8 col-sm-9">
	  				...
	  				<nav class="tm-nav">
						...
						<li style="margin-top: -10px;"><a href="" ><h5>Accueil</h5></a></li>
                            ...
                            <li style="margin-top: -10px;"><a href="evénements" class="active"><h5>Evénements</h5></a></li>
			  ...
			  <ul class="slides">
			    <li>
			      ...
			      <div class="flex-caption">
			      	<h2 class="slider-title">L'ouverture du centre</h2>
			      	<h3 class="slider-subtitle">Le 7 et Le 8 mai 2022 serons les grands jour car ça sera l'ouverture du centre </h3>

					<a href="http://127.0.0.1:8000/contact" target="_parent">contactez nous</a>. <br><br><div class="slider-social">
 ...
 </html><?php /**PATH C:\xampp\htdocs\THE29\resources\views/evenements.blade.php ENDPATH**/ ?>